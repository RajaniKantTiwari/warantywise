...
public class ImageActivity extends AppCompatActivity {
        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case ImageTags.IntentCode.CAMERA_REQUEST:
                    CompressImageTask task = new CompressImageTask(destination.getAbsolutePath(), mImgConfig
                            , ImageActivity.this);
                ...
                case ImageTags.IntentCode.REQUEST_CODE_SELECT_MULTI_PHOTO:
                    ...
                    if (data.getClipData() == null) {
                        ...
                        CompressImageTask taskAsync = new CompressImageTask(listOfImgs,
                                mImgConfig, ImageActivity.this);
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB)
    ...
    private void processOneImage(Intent data) {
        try {
            ...
            CompressImageTask task = new CompressImageTask(selectedImagePath,
                    mImgConfig, ImageActivity.this);
