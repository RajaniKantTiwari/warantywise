...
public class VideoActivity extends AppCompatActivity {
    ...
    private static final int MAX_VIDEO_TIME_SEC = 120;//2 min
    public static final long VIDEO_SIZE = 300 *1000  * 1000L; //300 MB
    ...
    private void startActivityFromCamera() {
        ...
        intent.putExtra(MediaStore.EXTRA_DURATION_LIMIT, MAX_VIDEO_TIME_SEC);
